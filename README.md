...
| **IconButton**           | performing action button                                                                                                                                                                                                                                                                                  | onPressed: `(){}, icon: Icon(Icons.shopping_cart)`                                                                                                                                                                                   |
| **FloatingActionButton** | round button that floats above the UI, usually at the bottom-right corner                                                                                                                                                                                                                                 | shape: `RoundedRectangleBorder()` , onPressed: `(){},child: Icon(Icons.add,color: Colors.white),);`                                                                                                                                                                                       |
| **BottomNavigationBar** | used to create a navigation bar at the bottom of the screen                                                                                                                                                                                                                                               | items:[`BottomNavigationBarItem()`]                                                                                                                                                                                                   |
